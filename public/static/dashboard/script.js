...
async function studentdata() {
    ...
    day=res.timetable[0]
    slots=['day','slot1','slot2','slot3','slot4','slot5','slot6','slot7','slot8','slot9']
    slots.forEach(e=>{
        document.querySelector('.card4text').innerHTML+=`${e} - ${day[e]} <br>`
    })
...
id:res.id
    ...
    document.querySelector('.qrcode').innerHTML+=`<img src='${qrcode.qr}'>`
    ...
    document.querySelector('.attendancegraph').innerHTML+=`<img src=data:image/png;base64,${resp.graph}>`
    res.marks.forEach(e=>{
